...
out_pdf <- file.path(out_dir, "2020_NR_plantHeight_daysToFlower_paniclesPerPlot_3cols_panelC_short.pdf")
...
# Panel C short format for stacking under A+B in Illustrator.
ggsave(out_pdf, combined_plot, width = 29.7, height = 10.5, units = "cm", bg = "white")

file.copy("/tmp/generate_2020_nr_three_traits_one_row.R",
          file.path(script_copy_dir, "generate_2020_nr_three_traits_one_row_panelC_short.R"),
          overwrite = TRUE)
